...
class Game {
  ...
  renderRoom(room, orientation, offset) {
    ...
    this.canvasCtx.translate(
      Math.floor(this.screenCenter.x - playerPosition.x + 4 + offset.x),
      Math.floor(this.screenCenter.y - playerPosition.y + 4 + offset.y)
    );
  ...
  DepthFirstFindRooms(prevRoomMask, currentRoom, orientation, offset, step) {
