    ...
    if (step < 3) {
      ...
      currentRoom.doors.forEach(door => {
        ...
        if (door !== blacklistedDoor) {
          ...
          doorwayLightConeCtx.globalCompositeOperation = "source-out";
...
},{"./player.js":3,"./room/room.js":5,"./util":6}],2:[function(require,module,exports){
...
class Door {
  ...
  getCoordinates(orientation) {
    ...
    switch (newPosition.orientation) {
      ...
      case 2:
        return [
          { x: newPosition.tile * 16 + 14, y: roomDimensions.height },
          { x: newPosition.tile * 16 + 1, y: roomDimensions.height }
        ];
      case 3:
        return [
  ...
  getCenterDimensions() {
    ...
    switch (this.position.orientation) {
      ...
      case 2:
        center.x = (this.position.tile) * 16 + 8;
        center.y = (this.room.height) * 16 + 4;
        dimensions.x = 14;
        dimensions.y = 8;
        break;
      case 3:
...
module.exports = Room;
},{"./door.js":4}],6:[function(require,module,exports){
module.exports = {
